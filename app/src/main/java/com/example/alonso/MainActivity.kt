...
class MainActivity : AppCompatActivity(),
    ...
    fun ShowPicture() {
        /*
        when (PictureNo) {
            0 -> img.setImageResource(R.drawable.pu1)
            1 -> img.setImageResource(R.drawable.pu2)
            2 -> img.setImageResource(R.drawable.pu3)
            3 -> img.setImageResource(R.drawable.pu4)
            4 -> img.setImageResource(R.drawable.pu5)
        }
        */
